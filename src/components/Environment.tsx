        ...
        <section id="medio-ambiente" data-reveal="fade-up" className="section-padding bg-emerald-900 text-white relative overflow-hidden">
            ...
            <div className="container-custom relative z-10 grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div data-reveal="fade-right" className="order-2 lg:order-1 relative">
                    <div className="absolute -inset-4 bg-accent/20 rounded-[2rem] blur-xl transform -rotate-2"></div>
                    <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-emerald-800/50">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-8">
                            <p className="font-bold text-xl text-white flex items-center gap-2">
                                <MapPin className="text-accent" /> Funes y Roldán
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div data-reveal="fade-left" className="space-y-8 order-1 lg:order-2">
                    <div>
                        ...
                        <h2 className="heading-primary text-white mb-6">Cuidamos nuestro <br /><span className="text-accent">Lugar en el Mundo</span></h2>
                        <p className="text-emerald-100 text-lg leading-relaxed max-w-xl">
                            No solo transportamos residuos, gestionamos el futuro de nuestra comunidad. Cada servicio se realiza bajo estrictas normas de cuidado ambiental.
                        </p>
                    </div>
                    ...
                    <div className="pt-4">
                        <a href="#contacto">
                            <Button className="bg-accent hover:bg-accent-dark text-white px-8 py-6 rounded-xl text-lg font-bold shadow-lg shadow-accent/20">
                                Sumate al Cambio
                            </Button>
                        </a>
                    </div>
